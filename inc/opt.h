...
/* _u => ua,ub */
void *opt_wch_new(const char *path, OPT_WATCH wch, void *ua, void *ub, int awch);

#define opt_awch(p, w) opt_wch_new((p), (w), NULL, NULL, 1)
#define opt_awch_u(p, w, ua, ub) opt_wch_new((p), (w), (void*)(ua), (void*)(ub), 1)
#define opt_bwch(p, w) opt_wch_new((p), (w), NULL, NULL, 0)
#define opt_bwch_u(p, w, ua, ub) opt_wch_new((p), (w), (void*)(ua), (void*)(ub), 0)
